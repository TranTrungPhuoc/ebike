...
class Delivery_Controllers extends Controllers{
    
    constructor(req, res){
        super(req, res)
        this.model = Delivery_Models
        this.title = 'title'
    }
    ...
    async formList(data){
        return [
            ...
            { title: 'Phí', type: 'number', col: 6, class: 'price form-control ', id: 'price', value: (data.length==0)?'':data[0]['price'], placeholder: '', require: false, disabled: false, check: false, event: '' },
        ]
    }
...
module.exports = Delivery_Controllers